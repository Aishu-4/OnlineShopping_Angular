...
export class CartService {
  ...
  constructor(private http:HttpClient) { }
    ...
    AddtoCart(val : any) {
        ...
        return this.http.post("http://localhost:23441/api/Cart/InsertIntoCart",val ,httpheader);
    }
    ...
    {
        const httpheader={headers:new HttpHeaders({'Content-Type':'application/json'})};
        return this.http.post("http://localhost:23441/api/Cart/PurchaseAllProducts?useremail="+useremail,httpheader);
    }

    QuantityIncr(usermail:any,pid:number)
    {
        const httpheader={headers:new HttpHeaders({'Content-Type':'application/json'})};
        return this.http.post("http://localhost:23441/api/Cart/QuantityIncr?umail="+usermail+"&pid="+pid,httpheader);
    }

    QuantityDecr(usermail:any,pid:number)
    {
        const httpheader={headers:new HttpHeaders({'Content-Type':'application/json'})};
        return this.http.post("http://localhost:23441/api/Cart/QuantityDecr?umail="+usermail+"&pid="+pid,httpheader);
    }
}
