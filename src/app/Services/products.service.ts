...
export class ProductsService {
  ...
  getAllProducts()
  {
    return this.http.get('http://localhost:23441/api/Products/AllProducts');
  }

  searchallProducts(s:string)
  {
    const httpheader={headers:new HttpHeaders({'Content-Type':'text/html'})};
    return this.http.get("http://localhost:23441/api/Products/SearchProduct?search="+s,httpheader);
  }

  getallcategories()
  {
    return this.http.get("http://localhost:23441/api/Products/GetCategory")
  }
