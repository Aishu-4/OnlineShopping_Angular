...
export class UserService{
    ...
    {
      return this.client.get("http://localhost:23441/api/User/GetUserDetails?umail="+usermail)
    }
    
    GetUserOrders(usermail:string)
    {
      return this.client.get("http://localhost:23441/api/User/GetUserOrders?umail="+usermail)
    }
